...
def popup():
    ...
    textbox1=Entry(popupwindow,text=stri)
    ak=stri.get()
    button1=Button(popupwindow,text="Ok",command=thread1)
    a.pack()
    button1.pack()
    textbox1.pack()
...
def save():
          ...
          def main():
              ...
              data1=songs(music)
              ak=ak+".wav"
              wavio.write(ak,data1,sample, sampwidth=2)
...
button_15=tkinter.Button(window,text="Save",borderwidth=0,fg="black",activebackground="blue2",command=thread)
