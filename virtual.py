import tkinter
import time
from tkinter import Toplevel,Button,Tk,Label,Entry
window= tkinter.Tk()
...
button_14=tkinter.Button(window,text="Save",borderwidth=0,fg="black",activebackground="blue2",command=window.destroy)
button_14.place(x=500,y=0)
def popup():
    popupwindow=Toplevel(window)
    popupwindow.title("Song Output")
    popupwindow.geometry("300x300")
    a=Label(popupwindow,text="Give The Song Name")
    textbox1=Entry(popupwindow)
    button1=Button(popupwindow,text="Ok",command=save)
    a.pack()
    button1.pack()
    textbox1.pack()
    popupwindow.mainloop()

button_15=tkinter.Button(window,text="Open",borderwidth=0,fg="black",activebackground="blue2",command=popup)
button_15.place(x=550,y=0)
